...
# This solution proved to be much better thanks to the Fraction library
# offered in Python. The library seemed to have been faster than my 
# Java solution in finding the best numerator and denominator.
def solution(pegs):
	if len(pegs) == 2:
